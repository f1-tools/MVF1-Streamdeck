...
const driverheaderoptions = ['NONE', 'OBC_LIVE_TIMING', 'DRIVER_HEADER'];
let driverheadermode = 0;
...
function doTileAction(device, driver) {
	...
	if (driverheadermode >= driverheaderoptions.length){
        ...
        graphql(
            ...
            `,
            { playerSetDriverHeaderModeId: driver.id, mode: driverheaderoptions[driverheadermode] }
        );
    } else if (
        defined_id &&
        multi_action_device_data[device].tile_caller ===
